...
public class testClass {
  ...
  public static final String AUTH_TOKEN = "a94eb2cd15673f55826758cd0fa4ad15";

  public static void main(String[] args) {
    Twilio.init(ACCOUNT_SID, AUTH_TOKEN);

//    Message message = Message.creator(new PhoneNumber("+201102908309"),
...
//-----------------------------------
        Message message = Message.creator(
            new com.twilio.type.PhoneNumber("+201102908309"),
